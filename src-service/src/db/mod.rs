...
async fn run_migrations(db: &SurrealDb) -> Result<(), surrealdb::Error> {
    let stmts: &[&str] = &[
        ...
        "DEFINE FIELD IF NOT EXISTS tool_calls           ON agent_skills TYPE option<string>;",
        ...
        "DEFINE FIELD IF NOT EXISTS skill_ids     ON agent_definitions TYPE option<string>;",
        "DEFINE FIELD IF NOT EXISTS tool_names    ON agent_definitions TYPE option<string>;",
        ...
        // ── memory rules ─────────────────────────────────────────────────────
        "DEFINE TABLE IF NOT EXISTS memory_rules SCHEMALESS;",
